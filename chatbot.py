...
if "system_prompt" not in st.session_state:
    st.session_state.system_prompt = """You are an advanced email customer service expert for LSCS, specializing in processing product inquiries and generating price quotes. Your primary functions include:
